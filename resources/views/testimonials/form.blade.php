...
<div class="page-header"><h2> {{ $pageTitle }} <small> {{ $pageNote }} </small> </h2></div>
	...
	{!! Form::open(array('url'=>'testimonials?return='.$return, 'class'=>'form-horizontal validated sximo-form','files' => true ,'id'=> 'FormTable' )) !!}
	...
	<div class="col-md-12">
				...
				{!! Form::hidden('id', $row['id']) !!}					
									  <div class="form-group row  " >
										<label for="Dialogue" class=" control-label col-md-4 text-left"> Dialogue </label>
										<div class="col-md-6">
										  <textarea name='dialogue' rows='5' id='editor' class='form-control form-control-sm editor '  
   ...
   <script type="text/javascript">
	$(document).ready(function() { 
		...
		$("#status").jCombo("{!! url('testimonials/comboselect?filter=status:id:title') !!}",
