...
class OurvolunteersController extends Controller {

	protected $layout = "layouts.main";
	protected $data = array();	
	public $module = 'ourvolunteers';
	static $per_page	= '50';

	public function __construct()
	{		
		parent::__construct();
		$this->model = new Ourvolunteers();	
		
		$this->info = $this->model->makeInfo( $this->module);	
		$this->data = array(
			'pageTitle'	=> 	$this->info['title'],
			'pageNote'	=>  $this->info['note'],
			'pageModule'=> 'ourvolunteers',
	...
	public static function display(  )
	{
		...
		$model  = new Ourvolunteers();
		$info = $model::makeInfo('ourvolunteers');
		$data = array(
		...
		if($mode == 'view')
		{
			...
			if($row)
			{
				...
				$data['id'] = $id;
				return view('ourvolunteers.public.view',$data);			
			}			
		} 
		else {
			...
			return view('ourvolunteers.public.index',$data);	
		}
