...
class RecentcausesController extends Controller {
	...
	public $module = 'recentcauses';
	static $per_page	= '50';

	public function __construct()
	{		
		parent::__construct();
		$this->model = new Recentcauses();	
		
		$this->info = $this->model->makeInfo( $this->module);	
		$this->data = array(
			'pageTitle'	=> 	$this->info['title'],
			'pageNote'	=>  $this->info['note'],
			'pageModule'=> 'recentcauses',
	...
	public static function display(  )
	{
		...
		$model  = new Recentcauses();
		$info = $model::makeInfo('recentcauses');
		$data = array(
		...
		if($mode == 'view')
		{
			...
			if($row)
			{
				...
				$data['id'] = $id;
				return view('recentcauses.public.view',$data);			
			}			
		} 
		else {
			...
			return view('recentcauses.public.index',$data);	
		}
